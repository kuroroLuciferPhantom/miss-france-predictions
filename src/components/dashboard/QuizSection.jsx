...
const QuizSection = ({ user }) => {
  ...
  if (quizResult) {
    return (
      <div className="bg-gradient-to-r from-pink-50 to-purple-50 dark:from-pink-950/30 dark:to-purple-950/30 rounded-lg p-8">
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
      <div className="px-8 py-12 relative overflow-hidden">
        <div className="absolute top-0 right-0 -mt-4 -mr-4 w-32 h-32 bg-gradient-to-br from-pink-200 to-purple-200 dark:from-pink-900/20 dark:to-purple-900/20 rounded-full opacity-20" />
        <div className="absolute bottom-0 left-0 -mb-4 -ml-4 w-24 h-24 bg-gradient-to-tr from-pink-200 to-purple-200 dark:from-pink-900/20 dark:to-purple-900/20 rounded-full opacity-20" />
        ...
        <div className="relative">
          ...
          <div className="prose text-gray-600 dark:text-gray-300 max-w-3xl mb-8">
            <p className="text-lg">
            ...
            <ul className="mt-4 space-y-2">
              {[
                ...
                <li key={text} className="flex items-center">
                  <svg className="w-5 h-5 mr-2 text-pink-500 dark:text-pink-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4">
            <button
              ...
              className="w-full sm:w-auto px-8 py-3 bg-gradient-to-r from-pink-500 to-purple-500 dark:from-pink-600 dark:to-purple-600 text-white rounded-lg font-medium hover:from-pink-600 hover:to-purple-600 dark:hover:from-pink-700 dark:hover:to-purple-700 transition-all transform hover:scale-105 shadow-md"
            >
              Commencer le test
            </button>
