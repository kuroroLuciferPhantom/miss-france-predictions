...
const QuizLeaderboard = ({ groupMembers }) => {
  ...
  if (loading) {
    return <div className="mt-6 bg-white dark:bg-gray-800 rounded-lg shadow p-4">
  ...
  return (
    <div className="mt-6 bg-white dark:bg-gray-800 rounded-lg shadow p-4">
      <div className="mb-4">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white">Classement Quiz</h2>
      </div>
      {quizResults.length > 0 ? (
        <div className="space-y-4">
          {quizResults.map((result, index) => (
            <div
              key={result.userId}
              className="flex items-center justify-between p-4 rounded-lg bg-gradient-to-r hover:from-pink-50 hover:to-purple-50 dark:hover:from-pink-900/20 dark:hover:to-purple-900/20"
            >
