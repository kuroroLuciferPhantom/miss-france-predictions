...
const GroupHeader = ({
    ...
    const toggleSection = (section) => {
        if (section === 'members') {
            ...
            // Si on ouvre les membres, on ferme les settings
            if (!showMembers) {
                setShowSettings(false);
            }
        } else if (section === 'settings') {
            setShowSettings(!showSettings);
            // Si on ouvre les settings, on ferme les membres
            if (!showSettings) {
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm mb-8">
            <div className="p-6">
                ...
                <div className="lg:hidden">
                    ...
                    {showSettings && (
                        <div className="mt-4 py-4 border-t border-gray-100 dark:border-gray-700 md:hidden">
                    ...
                    <div
                        className={`transition-all duration-200 ${showMembers ? 'max-h-[1000px] opacity-100' : 'max-h-0 opacity-0'
                            } overflow-hidden`}
                    >
