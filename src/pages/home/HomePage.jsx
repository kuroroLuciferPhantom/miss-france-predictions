...
const QuickRules = () => (
  ...
  <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
      <h3 className="text-xl font-bold mb-4 text-gray-900 dark:text-white">Comment jouer ?</h3>
...
const CallToAction = ({ onCreateGroup, onJoinGroup }) => (
  <motion.div 
    ...
    viewport={{ once: true }}
    variants={scrollVariants}
    className="bg-gradient-to-r from-pink-500 to-purple-500 dark:from-pink-600 dark:to-purple-600 text-white py-16 rounded-lg"
  >
